		...
		<div class="container-fluid"> 
			...
			<div class="row"> 
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-user"></span> Designations
						</div> <!-- /Panel Heading -->
						<div class="panel-body">
							<form method="POST" action="etits.php">
								<div class="container-fluid">
									<div class="table-responsive">
										<table class="table table-bordered table-hover">
											<thead>
												...
												<th width="7%"><center>Rate per Hour</center></th>
											...
											<tbody>
												...
												while($result = mysql_fetch_array($qDesig)){
													...
													echo '<tr>
													          <td><center><b>'.$jobid.'</b></center></td>
													          <td><center>'.$jobtitle.'</center></td>
													          <td><center>'.$jobrate.'</center></td>
													          <td><center>'.$jobdesc.'</center></td>
													          <td><center><a class="btn btn-primary btn-sm" href="javascript:window.open(\'updDesig.php?id='.$jobid.'\', \'updDesig\',\'fullscreen=1, menubar=0\')" target="updDesig">Edit</a>&nbsp&nbsp<a href="javascript:window.open(\'delDesig.php?id='.$jobid.'\', \'delDesig\',\'fullscreen=1, menubar=0\')" target="delDesig" class="btn btn-danger btn-sm">Delete</a></center></td>
													      </tr>';
												}
												?>
											</tbody><br>
